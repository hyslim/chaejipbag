...
export const FragmentCreate = () => {
  ...
  return (
    <main className="flex min-h-screen w-full justify-center bg-[#FFFEFB] sm:bg-[#f3f0ec]">
      ...
      <section className="flex min-h-screen w-full flex-col bg-[#FFFEFB] sm:max-w-[390px]" style={{ fontFamily: "'Pretendard Variable', sans-serif" }}>
        ...
        <div className="flex flex-1 flex-col gap-4 bg-[#FFFEFB] px-5 pb-36 pt-5">
